...
namespace MrHd\Swoole;

use Swoole\Coroutine;
use Swoole\Coroutine\Barrier;
use MrHd\Swoole\Cmd\BindUid;
use MrHd\Swoole\Cmd\CloseClient;
use MrHd\Swoole\Cmd\DeleteSession;
use MrHd\Swoole\Cmd\GetClientCount;
use MrHd\Swoole\Cmd\GetClientCountByGroup;
use MrHd\Swoole\Cmd\GetClientInfo;
use MrHd\Swoole\Cmd\GetClientList;
use MrHd\Swoole\Cmd\GetClientListByGroup;
use MrHd\Swoole\Cmd\GetClientListByUid;
use MrHd\Swoole\Cmd\GetGroupList;
use MrHd\Swoole\Cmd\GetSession;
use MrHd\Swoole\Cmd\GetUidCount;
use MrHd\Swoole\Cmd\GetUidList;
use MrHd\Swoole\Cmd\GetUidListByGroup;
use MrHd\Swoole\Cmd\IsOnline;
use MrHd\Swoole\Cmd\JoinGroup;
use MrHd\Swoole\Cmd\LeaveGroup;
use MrHd\Swoole\Cmd\SendToAll;
use MrHd\Swoole\Cmd\SendToClient;
use MrHd\Swoole\Cmd\SendToGroup;
use MrHd\Swoole\Cmd\SetSession;
use MrHd\Swoole\Cmd\UnBindUid;
use MrHd\Swoole\Cmd\UnGroup;
use MrHd\Swoole\Cmd\UpdateSession;
use MrHd\Swoole\Library\ClientPool;
...
class Api
{
     ...
     *
     * @param string $client 客户端
     * @param integer $type 具体要获取哪些数据，默认全部获取，也可按需获取，可选参数：MrHd\Swoole\Protocol::CLIENT_INFO_UID(绑定的uid) | MrHd\Swoole\Protocol::CLIENT_INFO_SESSION(session) | MrHd\Swoole\Protocol::CLIENT_INFO_GROUP_LIST(绑定的分组列表) | MrHd\Swoole\Protocol::CLIENT_INFO_REMOTE_IP（客户ip） | MrHd\Swoole\Protocol::CLIENT_INFO_REMOTE_PORT（客户端口） | MrHd\Swoole\Protocol::CLIENT_INFO_SYSTEM（客户系统信息）
     * @return array|null
     */
